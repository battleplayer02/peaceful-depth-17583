...
@section('content')
    ...
    <div class="card shadow col-lg-6">
        <h2 class="card-header card-title" style="text-align: center">Doctor Registration</h2>


            <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

            <form class="pt-4 card-body" action="regdoctor" method="post">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="text1" name="email" value="{{old('email')}}"
                                   placeholder="Enter a valid email address." type="text"
                                   aria-describedby="text1HelpBlock" class="form-control">
                        </div>
                        <span id="text1HelpBlock"
                              class="form-text text-muted">Your E-mail will be used for login.</span>
                        @error('email')
                        <span style="color: red; text-align: right">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="specialization" name="specialization" placeholder="Specialization" type="text"
                                   class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="experience" value="{{old('experience')}}" name="experience"
                                   placeholder="Experience" type="text" class="form-control"
                                   aria-describedby="experienceHelpBlock">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="department" value="{{old('department')}}" name="department"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="contact_number" value="{{old('contact_number')}}" name="contact_number"
                                   placeholder="Enter your contact number" type="text" class="form-control"
                                   aria-describedby="contact_numberHelpBlock">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="blood_group" value="{{old('blood_group')}}" name="blood_group"
                                   placeholder="Enter your Blood Group" type="text" class="form-control">
                        </div>
                        @error('blood_group')
                        <span style="color: red; text-align: right">{{$message}}</span>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="qualification" value="{{old('qualification')}}" name="qualification"
                                   placeholder="Qualification" type="text" class="form-control"
                                   aria-describedby="qualificationHelpBlock">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="hosp_id" value="{{old('hosp_id')}}" name="hosp_id"
                                   placeholder="Enter Your Hospital ID" type="text" class="form-control"
                                   aria-describedby="hosp_idHelpBlock">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="confirm_password" value="{{old('confirm_password')}}" name="confirm_password"
                                   placeholder="Re-Type Password" type="text" required="required" class="form-control">
                        </div>
